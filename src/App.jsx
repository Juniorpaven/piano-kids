...
const CHARACTERS = [
  ...
  { id: 'F', name: 'Ếch Pha', note: 'F', emoji: '🐸', color: '#6BCB77', freqRange: [340, 360] }, // Approx F4 ~349
  { id: 'G', name: 'Gấu Son', note: 'G', emoji: '🐻', color: '#4D96FF', freqRange: [380, 410] }, // Approx G4 ~392
];
      ...
      {gameState === 'PLAY' && (
        <div className="game-area fade-in">
          <div className="header-panel">
            <button className="btn-small" onClick={() => setGameState('MENU')}>🏠</button>
